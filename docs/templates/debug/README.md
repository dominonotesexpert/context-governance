...
These templates define bug governance owned by the Debug Agent.
...
Runtime debug cases should be stored under:

- `docs/agents/debug/cases/YYYY-MM-DD-<topic>.md`

The debug layer consumes system/module truth. It does not own system or module contracts.
